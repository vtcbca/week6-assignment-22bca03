...
q1= "insert into result values(1,'jay',67,45,58,90,45),(2,'vishal',56,34,56,78,45),(3,'vatsal0',67,76,83,50,54),(4,'meet',50,67,78,89,45),(5,'vision',45,67,78,50,78),(6,'abhishek',60,65,64,50,43),(7,'roshan',56,45,44,78,36),(8,'savan',56,67,45,49,50),(9,'harsh',46,62,43,39,57),(10,'sagar',67,64,54,56,78)"
cur1=conn.cursor()
cur1.execute(q1)
conn.commit()
